...
- <span class="glossary-term" data-definition="Collection logique de documents JSON dans Elasticsearch.">Index</span>
- <span class="glossary-term" data-definition="Unite de donnees en JSON stockee dans un index.">Document</span>
- <span class="glossary-term" data-definition="Propriete d'un document avec un type et un usage de recherche.">Champ</span>
- <span class="glossary-term" data-definition="Schema Elasticsearch qui definit les types de champs et leur comportement.">Mapping</span>
- <span class="glossary-term" data-definition="Champ analyse pour la recherche plein texte.">`text`</span>
- <span class="glossary-term" data-definition="Champ exact non analyse pour filtre, tri et aggregation.">`keyword`</span>
- <span class="glossary-term" data-definition="Requete de recherche plein texte adaptee aux champs textuels analyses.">`match`</span>
- <span class="glossary-term" data-definition="Requete de correspondance exacte sur la valeur indexee telle quelle.">`term`</span>
- <span class="glossary-term" data-definition="Format d'echange ligne par ligne utilise par Bulk API (newline delimited JSON).">NDJSON</span>
- <span class="glossary-term" data-definition="Requete de composition qui combine clauses obligatoires, filtres et options de pertinence.">`bool`</span>
- <span class="glossary-term" data-definition="Clause de bool query qui doit matcher et contribue au score.">`must`</span>
- <span class="glossary-term" data-definition="Clause de bool query obligatoire mais non scoree, ideale pour les contraintes exactes.">`filter`</span>
