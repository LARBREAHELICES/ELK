...
- <span class="glossary-term" data-definition="Configuration Kibana qui declare quels index lire et quels champs exposer.">Data View</span>
- <span class="glossary-term" data-definition="Langage de filtre Kibana utilise dans Discover et les dashboards.">KQL</span>
- <span class="glossary-term" data-definition="Interface Kibana de lecture des documents bruts avec filtres et tri.">Discover</span>
- <span class="glossary-term" data-definition="Editeur visuel Kibana pour construire des graphiques a partir d'aggregations Elasticsearch.">Lens</span>
- <span class="glossary-term" data-definition="Ecran de synthese qui assemble plusieurs visualisations et filtres interactifs.">Dashboard</span>
- <span class="glossary-term" data-definition="Filtres globaux interactifs ajoutables dans un dashboard (options list, range slider).">Controls</span>
- <span class="glossary-term" data-definition="Fonction Kibana qui montre la requete Elasticsearch reelle envoye par un panel.">Inspect</span>
- <span class="glossary-term" data-definition="Groupement ou calcul statistique Elasticsearch utilise par les visualisations Kibana.">Aggregation</span>
- <span class="glossary-term" data-definition="Filtre applique au niveau dashboard sur tous les panels actifs.">Pinned filter</span>
